...
// is 10 GB sufficient?
- [ ] T010 Implement TCP port check function (verify 44925/44926 availability based on version)
...
- [ ] T014 Implement admin password retrieval from aap-dev output (use aap-dev Makefile - `make admin-password`)
