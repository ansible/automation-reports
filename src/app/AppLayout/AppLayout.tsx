        ...
        <MastheadBrand data-codemods>
          <MastheadLogo data-codemods>
            <a href="/" aria-label="home">
              <svg style={{ height: '48px' }} xmlns="http://www.w3.org/2000/svg" id="aap-logo_svg__Logos" height="64" x="0" y="0" viewBox="0 0 1580.6 240.9">
                <path
                  fill={'#fff'}
                  ...
                  className="aap-logo_svg__st0"></path>
                <path
