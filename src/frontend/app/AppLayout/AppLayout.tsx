...
import { Masthead, MastheadBrand, MastheadLogo, MastheadMain, Page } from '@patternfly/react-core';
...
const AppLayout: React.FunctionComponent<IAppLayout> = ({ children }) => {
  ...
  return (
    <Page mainContainerId={pageId} masthead={masthead} sidebar={null} mainComponent={'main'}>
      {children}
    </Page>
  );
};
