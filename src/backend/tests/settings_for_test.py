...
DEFAULT_MANUAL_COST_AUTOMATION = 60

# Default Monthly AAP cost
DEFAULT_AUTOMATED_PROCESS_COST = 10000
...
SECRET_KEY = 'test_secret_key_for_backend_tests'
DATABASE_KEY = 'test_database_key_for_backend_tests'
