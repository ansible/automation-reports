...
from backend.api.schema import AuthenticatedSpectacularAPIView, AuthenticatedSpectacularSwaggerView, \
    AuthenticatedSpectacularRedocView
from backend.utils.schema import CustomAutoSchema
