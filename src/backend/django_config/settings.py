...
LOGGING = {
    ...
    "loggers": {
        ...
        'automation_dashboard.auth': {'handlers': ['console', 'file', 'automation_dashboard_warnings'], 'level': 'INFO'},
        'automation_dashboard.jwt': {'handlers': ['console', 'file', 'automation_dashboard_warnings'], 'level': 'INFO'},
        'automation_dashboard.clusters.connector': {'handlers': ['console', 'file', 'automation_dashboard_warnings'], 'level': 'INFO'},
        'automation_dashboard.clusters.encryption': {'handlers': ['console', 'file', 'automation_dashboard_warnings'], 'level': 'INFO'},
        'automation_dashboard.clusters.parser': {'handlers': ['console', 'file', 'automation_dashboard_warnings'], 'level': 'INFO'},
...
# Default monthly subscription of AAP
...
DISPATCHERD_DEBUGGING_SOCKFILE = "/tmp/automation-dashboard-dispatcher.sock"
