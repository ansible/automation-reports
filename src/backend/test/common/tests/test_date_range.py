...
class TestDateRange:
    ...
    def test_last_year(self, patch_datetime_now) -> None:
    ...
    def test_last_6_month(self, patch_datetime_now) -> None:
    ...
    def test_quarter_to_date(self, patch_datetime_now) -> None:
