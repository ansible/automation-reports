...
class TestDateRange(TestCase):
    ...
    def test_last_year(self) -> None:
        ...
        assert result["prev_start"] == "2023-01-01T00:00:00Z"
        assert result["prev_end"] == "2023-12-31T23:59:59.999999Z"
    ...
    def test_last_6_month(self) -> None:
        ...
        assert result["prev_start"] == "2024-10-01T00:00:00Z"
        assert result["prev_end"] == "2025-03-30T23:59:59.999999Z"
    ...
    def test_last_3_month(self) -> None:
        ...
        assert result["end"] == "2025-09-30T23:59:59.999999Z"
        assert result["prev_start"] == "2025-04-01T00:00:00Z"
        assert result["prev_end"] == "2025-06-30T23:59:59.999999Z"
    ...
    def test_last_month(self) -> None:
        ...
        assert result["end"] == "2025-09-30T23:59:59.999999Z"
        assert result["prev_start"] == "2025-08-01T00:00:00Z"
        assert result["prev_end"] == "2025-08-31T23:59:59.999999Z"
    ...
    def test_year_to_date(self) -> None:
        ...
        assert result["prev_start"] == "2024-01-01T00:00:00Z"
        assert result["prev_end"] == "2024-10-21T23:59:59.999999Z"
    ...
    def test_quarter_to_date(self) -> None:
        ...
        assert result["end"] == "2025-10-21T23:59:59.999999Z"
        assert result["prev_start"] == "2025-07-01T00:00:00Z"
        assert result["prev_end"] == "2025-07-21T23:59:59.999999Z"

    def test_month_to_date(self) -> None:
        result = DateRangeChoices.get_date_range(DateRangeChoices.MONTH_TO_DATE).iso_format
        assert result["start"] == "2025-10-01T00:00:00Z"
        assert result["end"] == "2025-10-21T23:59:59.999999Z"
        assert result["prev_start"] == "2025-09-01T00:00:00Z"
        assert result["prev_end"] == "2025-09-21T23:59:59.999999Z"
    ...
    def test_last_3_years(self) -> None:
        ...
        assert result["end"] == "2024-12-31T23:59:59.999999Z"
        assert result["prev_start"] == "2019-01-01T00:00:00Z"
        assert result["prev_end"] == "2021-12-31T23:59:59.999999Z"
    ...
    def test_last_2_years(self) -> None:
        ...
        assert result["end"] == "2024-12-31T23:59:59.999999Z"
        assert result["prev_start"] == "2021-01-01T00:00:00Z"
        assert result["prev_end"] == "2022-12-31T23:59:59.999999Z"
    ...
    def test_custom_date_range(self) -> None:
        ...
        assert result["prev_start"] == "2018-11-25T00:00:00Z"
        assert result["prev_end"] == "2021-05-13T23:59:59.999999Z"
    ...
    def test_quarter_to_date_whole_quarter(self) -> None:
        ...
        assert result["prev_start"] == "2025-07-01T00:00:00Z"
        assert result["prev_end"] == "2025-09-30T23:59:59.999999Z"
    ...
    def test_quarter_to_date_first_quarter(self) -> None:
        ...
        assert result["prev_start"] == "2024-10-01T00:00:00Z"
        assert result["prev_end"] == "2024-10-31T23:59:59.999999Z"
